...
import { FaHorse, FaPalette } from 'react-icons/fa';
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="relative flex items-center justify-center my-20 w-full"
      >
        {/* Línea decorativa con gradiente */}
        <div className="absolute w-full h-[2px] bg-gradient-to-r from-transparent via-[var(--color-1)] to-transparent opacity-70"></div>
        ...
        >
          <span className="relative -top-0.5 text-[var(--color-1)]  text-2xl">✦</span>
        </motion.div>
      </motion.div>
    </motion.section>
  );
